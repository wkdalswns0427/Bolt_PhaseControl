...
class A2CAgent(a2c_common.ContinuousA2CBase):
    ...
    def calc_gradients(self, input_dict):
        ...
        with torch.cuda.amp.autocast(enabled=self.mixed_precision):
            ...
            mirror_loss, contact_forces = self.compute_mirror_loss(self.model,batch_dict)
            loss = a_loss + 0.5 * c_loss * self.critic_coef - entropy * self.entropy_coef + b_loss * self.bounds_loss_coef + mirror_loss*self.mirror_loss_weight
        ...
        self.train_result = (a_loss, c_loss, entropy, \
            ...
            mu.detach(), sigma.detach(), b_loss, mirror_loss, contact_forces) # add mirror_loss, contact_forces
...
###################################################################################################
    def compute_mirror_loss(self, policy, batch_dict):
        num_obvs = 44
        self.history_len = 1
        ...
        return mirror_loss , obs_batch[40:42]
